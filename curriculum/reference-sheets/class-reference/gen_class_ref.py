...
ARM_CODE = [
    ...
    ('comment',     '    // no sensor feedback on XRP servo'),
    ('comment',     '    // commandedAngleDeg tracked by subsystem'),
    ('method',      '  }'),
    ('comment',     ''),
    ('method',      '  @Override'),
    ('method',      '  public void setAngle(double angleDeg) {'),
    ('method',      '    armServo.setAngle(angleDeg);'),
    ('comment',     '      // direct hardware call — no logic here'),
    ('method',      '  }'),
    ('shell',       '}'),
...
SIM_CODE = [
    ...
    ('method',      '  @Override'),
    ('method',      '  public void updateInputs(ArmIOInputs inputs) {'),
    ('comment',     '    // no sensor feedback; commandedAngleDeg tracked by subsystem'),
    ('method',      '  }'),
    ('method',      '  @Override'),
    ('method',      '  public void setAngle(double angleDeg) {'),
    ('comment',     '    // no hardware to command in sim'),
    ('method',      '  }'),
    ('shell',       '}'),
]  # 13 lines
...
ARM_SUB_RIGHT = [
    ...
    ('viz',         '    Logger.recordOutput("FinalComponentPoses",'),
    ('viz',         '        new Pose3d[] { ... });'),
    ('comment',     ''),
    ...
    ('akit',        '    inputs.commandedAngleDeg = clamped;'),
    ('comment',     '      // sync logged value (no sensor on servo)'),
    ('method',      '  }'),
    ('comment',     ''),
